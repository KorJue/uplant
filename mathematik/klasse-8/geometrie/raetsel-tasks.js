...
import { lineThroughBoth } from "./check-helpers.js?v=20";
import { TRI_TASKS, findMediatrice, findMedian, findAltitude, circlesAt, pairPoints } from "./tri-construct.js?v=20";
