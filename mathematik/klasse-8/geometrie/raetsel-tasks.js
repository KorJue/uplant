...
import { lineThroughBoth } from "./check-helpers.js?v=16";
import { TRI_TASKS, findMediatrice, findMedian, findAltitude, circlesAt, pairPoints } from "./tri-construct.js?v=16";
