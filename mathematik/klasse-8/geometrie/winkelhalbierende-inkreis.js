...
import { drawWinkelhalbierende, drawInkreis } from "./constructions.js?v=10";
import { TRI_TASKS } from "./tri-construct.js?v=10";
import { setupTrianglePage } from "./tri-page.js?v=10";
