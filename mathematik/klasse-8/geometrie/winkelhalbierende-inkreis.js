...
import { drawWinkelhalbierende, drawInkreis, drawLotSchritt } from "./constructions.js?v=24";
import { TRI_TASKS } from "./tri-construct.js?v=24";
import { setupTrianglePage } from "./tri-page.js?v=24";
