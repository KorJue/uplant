...
import { drawWinkelhalbierende, drawInkreis, drawLotSchritt } from "./constructions.js?v=23";
import { TRI_TASKS } from "./tri-construct.js?v=23";
import { setupTrianglePage } from "./tri-page.js?v=23";
