...
import { drawWinkelhalbierende, drawInkreis } from "./constructions.js?v=15";
import { TRI_TASKS } from "./tri-construct.js?v=15";
import { setupTrianglePage } from "./tri-page.js?v=15";
