...
import { drawWinkelhalbierende, drawInkreis } from "./constructions.js?v=17";
import { TRI_TASKS } from "./tri-construct.js?v=17";
import { setupTrianglePage } from "./tri-page.js?v=17";
