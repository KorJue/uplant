...
import { drawWinkelhalbierende, drawInkreis, drawLotSchritt } from "./constructions.js?v=20";
import { TRI_TASKS } from "./tri-construct.js?v=20";
import { setupTrianglePage } from "./tri-page.js?v=20";
